...
df = pd.read_csv('crawling_data/all_raw_data.csv')
print(df.head())
"""
...
stopwords_list = list(stopwords.stopword)  #기존 불용어단어들을 리스트로 받고 새로운 불용어 리스트도 더해 합쳐준다
...
print(df.info())
df.to_csv('./crawling_data/cleaned_summary.csv')